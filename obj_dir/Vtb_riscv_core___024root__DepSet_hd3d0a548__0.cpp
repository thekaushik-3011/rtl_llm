...
VL_INLINE_OPT VlCoroutine Vtb_riscv_core___024root___eval_initial__TOP__Vtiming__1(Vtb_riscv_core___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtb_riscv_core__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_riscv_core___024root___eval_initial__TOP__Vtiming__1\n"); );
    // Body
...
void Vtb_riscv_core___024root___eval_triggers__act(Vtb_riscv_core___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtb_riscv_core__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_riscv_core___024root___eval_triggers__act\n"); );
    // Body
